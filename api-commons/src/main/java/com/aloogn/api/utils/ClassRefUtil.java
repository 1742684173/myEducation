...
public class ClassRefUtil {
	...
	public static Object setValue(Class clazz, Map<String, Object> mapValue) throws Exception {
		...
		if (fields != null) {
			...
			for (int i = 0; i < fields.length; i++) {
				...
				if ("serialVersionUID".equals(fieldName) || fieldName.startsWith("__"))
					continue;
	...
	public static Object formatValue(String type, Object value) {
		if ("java.lang.String".equals(type)) {
			return isNullOrKong(value) ? null : String.valueOf(value);
		} else if ("java.math.BigDecimal".equals(type)) {
			return isNullOrKong(value) ? null : new BigDecimal(value.toString());
	 ...
	 * @throws Exception 
	 */
	public static Method getDeclaredMethod(Object object, String methodName, Class<?>... parameterTypes) throws Exception {
